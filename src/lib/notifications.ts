...
const INITIAL: Notification[] = [
  ...
  },
  {
    ...
    body: "Customer 07011223344 left a 42-second voice message while your line was busy. Your AI assistant has transcribed and summarised it: they want to place a repeat order for 6 yards of navy Shadda and asked about delivery to Abuja. Tap to open the traffic log and reply.",
    time: "Today · 10:15 AM",
    category: "AI Assistant",
    unread: true,
    priority: "medium",
